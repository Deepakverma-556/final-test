...
const OrderDetails = ({
  ...
  return (
    <div className="lg:max-w-[505px] w-full relative">
      <div className="max-h-[458px] lg:sticky lg:top-0 py-5 border border-solid border-black/10 rounded-[20px] w-full px-6 flex flex-col gap-6">
        ...
        <div className="flex flex-col w-full gap-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <p className="text-xl max-md:text-base font-bold text-customRed">
              {"-$" + discount}
            </p>
          </div>
          <div className="flex items-center justify-between">
        ...
        <form className="flex w-full items-center gap-3">
          <div className="w-full bg-lightGray items-center flex gap-3 rounded-[62px] h-[48px] pl-4">
            <PromoCodeIcon />
            <input
              type="text"
