...
const NewArrivals = () => {
  return (
    <div className="pt-[72px] pb-16 max-md:pt-[50px]">
            ...
            <SwiperSlide key={i} className="max-lg:pb-16 max-sm:pb-12">
              <div className="bg-fade rounded-[20px] flex items-center justify-center px-[38px] py-[34px] max-sm:px-8 max-sm:py-6">
                <Image
                  src={obj.image}
                  alt={obj.imgAlt}
                  className="h-[230px] w-[219px] max-xl:h-[180px] max-xl:min-w-[170px] max-md:h-[120px] max-md:min-w-[100px] max-sm:h-[150px] max-sm:min-w-[150px]"
                />
              </div>
              ...
              <div className="flex items-center gap-[13px]">
                <Image
                  src={obj.ratingStar}
                  alt={obj.ratingAlt}
                  className="h-[18.49px] max-w-max max-sm:h-[15.47px]"
                />
